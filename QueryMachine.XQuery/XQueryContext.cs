...
namespace DataEngine.XQuery
{
    ...
    public class XQueryContext
    {
        ...
        public void AggregateMultiplyException(AggregateException aggEx)
        {
            AggregateMultiplyException(aggEx.Flatten().InnerExceptions);
        }

        public void AggregateMultiplyException(IEnumerable<Exception> exceptions)
        {
            List<Exception> list = new List<Exception>(exceptions);
            throw list[0];
        }
        ...
        public virtual bool EnableHashJoin { get { return true; } }
    ...
    public class XPathContext : XQueryContext
    {
        ...
        public override bool EnableHashJoin
        {
            get
            {
                return false;
